...
**/etc/datadog-agent/process.d/conf.yaml** 파일 설정 후 **datadog-agent** 재시작하여 사용  
ex) name: 프로세스명_포트(옵션)
```json
init_config:
...
**/etc/datadog-agent/http_check.d/conf.yaml** 파일 설정 후 **datadog-agent** 재시작하여 사용  
...
**/etc/datadog-agent/tcp_check.d/conf.yaml** 파일 설정 후 **datadog-agent** 재시작하여 사용  
